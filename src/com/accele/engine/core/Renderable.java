 ...
 * <p>
 * While the instance of {@link Engine} contains a <tt>getGraphics</tt> method, it cannot be used to render to the screen, rather it is used for setting and retrieving data such as color and font.
...
public interface Renderable {
	 ...
	 * @param g The instance of <tt>Graphics</tt> to be used for rendering
	 */
