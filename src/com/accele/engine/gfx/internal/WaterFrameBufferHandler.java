...
public final class WaterFrameBufferHandler {
	...
	private Property screenWidth;
	private Property screenHeight;
	...
	public WaterFrameBufferHandler(Engine engine) {
		this.screenWidth = engine.getRegistry().getProperty("internal:screenWidth");
		this.screenHeight = engine.getRegistry().getProperty("internal:screenHeight");
