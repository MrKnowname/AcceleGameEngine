...
public class SoundStore {
	...
	private HashMap<Object, Object> loaded = new HashMap<>();
	...
	public Audio getOgg(File f) throws Exception {
		InputStream in = new BufferedInputStream(new FileInputStream(f));
		return getOgg(in);
	}

	public Audio getWAV(File f) throws Exception {
		InputStream in = new BufferedInputStream(new FileInputStream(f));
		return getWAV(in);
	}

	public Audio getMOD(File f) throws Exception {
		return getMOD(AudioSystem.getAudioInputStream(f));
	}

	public Audio getAIF(File f) throws Exception {
		return getAIF(AudioSystem.getAudioInputStream(f));
	}
