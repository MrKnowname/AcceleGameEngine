package tmp.normalMappingRenderer;
...
import tmp.shaders.ShaderProgram;

public class NormalMappingShader extends ShaderProgram{
	
	private static final int MAX_LIGHTS = 4;
	
	private static final String VERTEX_FILE = "src/tmp/normalMappingRenderer/normalMapVShader.txt";
	private static final String FRAGMENT_FILE = "src/tmp/normalMappingRenderer/normalMapFShader.txt";
